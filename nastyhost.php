...
<main>
 ...
 <p>You can contact the owner of this faucet on ExpressCrypto and request to be whitelisted through a private message like this: <code>/pm <?php echo $cfg_ec_username; ?> Your faucet, <?php echo $cfg_site_url; ?>, says my IP (<?php echo user_ip(); ?>) is blocked by NastyHosts. Could I please be whitelisted? Thanks in advance!</code></p>
