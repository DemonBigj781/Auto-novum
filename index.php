...
<center><table width="99%" bgcolor="#F2F3F4"></center>
 ...
 <p>Just enter your <b>Unique ID</b> below, select your currency, hit submit, and then leave the page open for tons of satoshi!</p>
 ...
 <p>(This faucet requires your <b>Unique ID</b> from <a href="https://expresscrypto.io/signup?referral=1">ExpressCrypto</a>)</p>
 ...
 <div style="padding-left: 1em">
  <form action="verify.php" method="post">
   ...
   <select name="currency" required="required">
    ...
    <?php if ($cfg_BCN_enabled) {echo '<option '; if (isset($referrer_currency) && ($referrer_currency == 'BCN')) {echo 'selected="selected" ';} echo 'value="BCN">BCN (~' . ($cfg_BCN_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
	...
	<?php if ($cfg_EXG_enabled) {echo '<option '; if (isset($referrer_currency) && ($referrer_currency == 'EXG')) {echo 'selected="selected" ';} echo 'value="EXG">EXG (~' . ($cfg_EXG_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
    <?php if ($cfg_EXS_enabled) {echo '<option '; if (isset($referrer_currency) && ($referrer_currency == 'EXS')) {echo 'selected="selected" ';} echo 'value="EXS">EXS (~' . ($cfg_EXS_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
	<?php if ($cfg_LSK_enabled) {echo '<option '; if (isset($referrer_currency) && ($referrer_currency == 'LSK')) {echo 'selected="selected" ';} echo 'value="LSK">LSK (~' . ($cfg_LSK_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
	...
	<?php if ($cfg_NEO_enabled) {echo '<option '; if (isset($referrer_currency) && ($referrer_currency == 'NEO')) {echo 'selected="selected" ';} echo 'value="NEO">NEO (~' . ($cfg_NEO_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
	...
	<?php if ($cfg_XRP_enabled) {echo '<option '; if (isset($referrer_currency) && ($referrer_currency == 'XRP')) {echo 'selected="selected" ';} echo 'value="XRP">XRP (~' . ($cfg_XRP_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
	<?php if ($cfg_STRAT_enabled) {echo '<option '; if (isset($referrer_currency) && ($referrer_currency == 'STRAT')) {echo 'selected="selected" ';} echo 'value="STRAT">STRAT (~' . ($cfg_STRAT_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
	...
	<?php if ($cfg_WAVES_enabled) {echo '<option '; if (isset($referrer_currency) && ($referrer_currency == 'WAVES')) {echo 'selected="selected" ';} echo 'value="WAVES">WAVES (~' . ($cfg_WAVES_amount) . ' every ' . ($cfg_refresh_time / 60) . ' minutes)</option>';} ?>
 ...
 <p>Referral link: <code><?php echo htmlspecialchars($cfg_site_url); ?>?r=<var>YOUR_Unique_ID</var>&amp;rc=<var>CURRENCY</var></code> (rotator owners, please append <code>&amp;rotator=YOUR_ROTATOR_NAME</code> to the URL)</p>
